...
* EPUB Files
The [[https://github.com/sbsdev/epub-sample-book/releases][releases]] contains EPUB books that incorporates all elements from
the DTBook schema. There are three variants:
